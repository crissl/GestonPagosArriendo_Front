...
import { nombreC } from '../sidebar/sidebar.component';
...
export class NavbarComponent implements OnInit {
    // public nombreCo = nombreC;
    // public nombrec = environment.usuarioId;
    // public nombreS: any
    ...
    // nombres;
    constructor(private personaldataService: PersonalDataService, private authService: AuthService, location: Location, private element: ElementRef, private router: Router, public Sidebar: SidebarComponent) {
    ...
    ngOnInit() {
        ...
        // this.nombreS = this.Sidebar.initialiseInvites1;
    }
