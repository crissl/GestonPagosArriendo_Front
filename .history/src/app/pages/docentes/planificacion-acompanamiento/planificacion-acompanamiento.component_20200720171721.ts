...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  listarDatosDocente() {
    this.restService.findDataById("datosDocentes/", this.spidem).subscribe(
      data => {
  ...
  guardarTutorias() {
    ...
    this.BuscarIdPlanif(); ///ELIMINAR UNA VEZ DESCOMENTADO ABAJO
  ...
  CrearModelo() {
    ...
    //this.CrearAsistencia();  !!IMPORTANTES DESCOMENTAR
    this.enviarEmail();   //!!!ELIMAR UNA VEZ DESCOMETADO ARRIBA
  }
  ...
  enviarEmail() {
    ...
    this.envios = {
      ...
      mensaje: "<b> usted ha sido notificado <b> <br>  "
        + " Para asistir a una tutoria de : " + this.datosGuardar.tipoTutoria + " , fue establecida para la fecha " + this.datosGuardar.fechaTutoria + " ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
  ...
  enviarEmail2() {
    ...
    this.envios = {
      asunto: "Planificacíon de la asignatura ",
      mensaje: "<b> la planificacíon de la tutoria de <b> <br>  "
       + this.datosGuardar.tipoTutoria + " Fue llenada y enviada a los estudiantes exitosamente " +  ", establecida para la fecha" + this.datosGuardar.fechaTutoria + " en el horario" + this.horaInicio+ this.horaFin +" ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
