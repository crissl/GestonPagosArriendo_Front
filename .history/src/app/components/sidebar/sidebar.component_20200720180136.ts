...
export const ROUTESE: RouteInfo[] = [  //Acompañamiento Estudiante
  ...
  { path: '/solicitudAcompanamiento', title: 'Generar', icon: 'speaker_notes', class: '' },
  { path: '/confirmacionAsistencia', title: 'Facturas', icon: 'ballot', class: '' },
...
export const ROUTESRE: RouteInfo[] = [ //Reforzamiento Estudiante
  ...
  { path: '/solicitudReforzamiento', title: 'nuevo', icon: 'speaker_notes', class: '' },
